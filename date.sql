...
-- jour
select (extract( hour from dateHeureSotrie ) - extract( hour from dateHeureDepart )) as heure_par_empl , numeroEmploye, extract( year from dateHeureDepart ) as annee , ExtRACT( day from dateHeureDepart ) as jour  ,extract( month from dateHeureDepart ) as mois
from pointage
...
-- mois
select (extract( hour from dateHeureSotrie ) - extract( hour from dateHeureDepart )) as heure_par_empl , numeroEmploye, extract( year from dateHeureDepart ) as annee  ,extract( month from dateHeureDepart ) as mois
from pointage
group by ExtRACT( year from dateHeureDepart ) , ExtRACT( month from dateHeureDepart ),numeroEmploye
;

-- semaine
select (extract( hour from dateHeureSotrie ) - extract( hour from dateHeureDepart )) as heure_par_empl , numeroEmploye, extract( year from dateHeureDepart ) as annee  ,extract( month from dateHeureDepart ) as mois , extract( week from dateHeureDepart ) as week
from pointage
...
select sum((extract( hour from dateHeureSotrie ) - extract( hour from dateHeureDepart ))) , ExtRACT( year from dateHeureDepart )  as annee , ExtRACT( month from dateHeureDepart ) as mois , ExtRACT( day from dateHeureDepart ) as jour
from pointage
...
-- mois
select sum((extract( hour from dateHeureSotrie ) - extract( hour from dateHeureDepart ))) , ExtRACT( year from dateHeureDepart )  as annee , ExtRACT( month from dateHeureDepart ) as mois
from pointage
...
-- Liste olona tsy nahavita 40h/semaine (heure tsy vitany eo akaikiny)
 ...
 /
select (40 - sum((extract( hour from dateHeureSotrie ) - extract( hour from dateHeureDepart )))) as heure_requise , numeroEmploye , ExtRACT( week from dateHeureDepart )
from pointage
...
create or replace view heure_req as (
    select (40 - sum((extract( hour from dateHeureSotrie ) - extract( hour from dateHeureDepart )))) as heure_requise , numeroEmploye , ExtRACT( week from dateHeureDepart ) as week
    from pointage
    group by ExtRACT( year from dateHeureDepart ) ,   ExtRACT( week from dateHeureDepart ) , numeroEmploye  
);
...
-- semaine
select count(*) , extract( year from dateHeureDepart ) , extract( month from dateHeureDepart )  , extract( week from dateHeureDepart )  from pointage
group by ExtRACT( year_month from dateHeureDepart ) ,ExtRACT( week from dateHeureDepart )
;

-- mois 
select count(*) , extract( year from dateHeureDepart ) , extract( month from dateHeureDepart )  from pointage
